...
Fraction.prototype = {
  ...
  "mod": function (a, b) {
     ...
     *
     *    n1/d1 = (n2/d2) * q + r, where 0 Ã¢â€°Â¤ r < n2/d2
  ...
  "pow": function (a, b) {
    ...
    //     (-a/b)^(c/d) = x
    // Ã¢â€¡â€ (-1)^(c/d) * (a/b)^(c/d) = x
    // Ã¢â€¡â€ (cos(pi) + i*sin(pi))^(c/d) * (a/b)^(c/d) = x
    // Ã¢â€¡â€ (cos(c*pi/d) + i*sin(c*pi/d)) * (a/b)^(c/d) = x       # DeMoivre's formula
  ...
  "roundTo": function (a, b) {
    ...
    /*
    k * x/y Ã¢â€°Â¤ a/b < (k+1) * x/y
    Ã¢â€¡â€ k Ã¢â€°Â¤ a/b / (x/y) < (k+1)
    Ã¢â€¡â€ k = floor(a/b * y/x)
    Ã¢â€¡â€ k = floor((a * y) / (b * x))
    */
  ...
  "simplify": function (eps = 1e-3) {
    ...
    // generally outperforming mediants in denominatorÃ¢â‚¬â€œaccuracy trade-offs.
