...
const isIPv6Loopback = (host) => {
  ...
  // Node's URL parser normalises ::ffff:127.0.0.1 Ã¢â€ â€™ ::ffff:7f00:1
  ...
  if (v4MappedHex) {
    ...
    // High 16 bits must start with 127 (0x7f) Ã¢â‚¬â€ i.e. 0x7f00..0x7fff
...
const normalizeNoProxyHost = (hostname) => {
  ...
  // IPv4 shorthand/octal/hex Ã¢â€ â€™ dotted-decimal; helper is a no-op for inputs
